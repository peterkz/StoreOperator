    ...
    private void populateAttributes(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        try {
            ...
            int defaultInActiveColor = isShiftingMode() ?
                    ContextCompat.getColor(context, R.color.title_color) : ContextCompat.getColor(context, R.color.bb_inActiveBottomBarItemColor);
            int defaultActiveColor = isShiftingMode() ? ContextCompat.getColor(context, R.color.title_color) : primaryColor;
